...
/**
  * It uploads the duty cycle into timer registers.
  */
bool ThreePwm_IsFastDemagUpdated( PWMC_ThreePwm_Handle_t * pHandle );
 ...
 */
void ThreePwm_UpdatePwmDemagCounter( PWMC_ThreePwm_Handle_t * pHandle );

/**
  * It disables the update event and the updated of the demagnetization counter.
 */
void ThreePwm_DisablePwmDemagCounter( PWMC_ThreePwm_Handle_t * pHandle );
/**
  * @}
  */
